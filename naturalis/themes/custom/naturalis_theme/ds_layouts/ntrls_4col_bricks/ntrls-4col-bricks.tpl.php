...
/**
 * @file
 * Template for Naturalis Theme Four column bricks Display Suite layout.
 */
?>
<<?php print $layout_wrapper; print $layout_attributes; ?> class="ntrls-4col-bricks <?php print $classes;?>">
