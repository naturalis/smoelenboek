...
/**
 * @file
 * Template for Naturalis Theme Three column bricks Display Suite layout.
 */
?>
<<?php print $layout_wrapper; print $layout_attributes; ?> class="ntrls-3col-bricks <?php print $classes;?>">
